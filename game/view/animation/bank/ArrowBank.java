...
public class ArrowBank extends EntityAnimationBank {
	...
	protected void loadSpecificAnimation (Sprite spriteFile) {
		BufferedImage[] hautgauche_img = new BufferedImage[1]; //je vais le changer
		BufferedImage[] haut_img = new BufferedImage[1]; //je vais le changer
		BufferedImage[] hautdroite_img = new BufferedImage[1]; //je vais le changer
		BufferedImage[] basgauche_img = new BufferedImage[1]; //je vais le changer
		...
		hautgauche_img[0] = spriteFile.m_images[7];
		haut_img[0] = spriteFile.m_images[1];
		hautdroite_img[0] = spriteFile.m_images[7];
		basgauche_img[0] = spriteFile.m_images[4];
