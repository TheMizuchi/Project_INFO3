	...
	public void attaque () {
		...
		while (it.hasNext()) {
			...
			if (!e.equal(m_e)) {
				...
				if ((e.m_hitbox.pointInHitbox(m_p1) || e.m_hitbox.pointInHitbox(m_p2) || e.m_hitbox.pointInHitbox(m_p3) || e.m_hitbox.pointInHitbox(m_p4)) || pointInHitbox(e.getHitbox().getP1()) || pointInHitbox(e.getHitbox().getP2()) || pointInHitbox(e.getHitbox().getP3()) || pointInHitbox(e.getHitbox().getP4())) {
					m_e.attack(e);
				}
			}
		}
