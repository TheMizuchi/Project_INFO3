 ...
 *
 * Created on: March, 2020 Author: Dr. Michaël Périn, Univ. Grenobles-Alpes
 */

/*
 * USAGE (see Automaton.java) Ast ast; ...; Aut_to_Dot_Visitor visitor = new
 * Aut_to_Dot_Visitor(); ast.accept(visitor);
